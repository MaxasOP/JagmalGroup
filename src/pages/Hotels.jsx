...
const hotels = [
    {
      ...
      rooms: 100,
      status: 'Upcoming',
      description: 'A contemporary smart hotel designed for the modern traveler, offering comfort and convenience,next to Naini Railway Station Prayagraj.',
    ...
    },
    {
      ...
      rooms: 57,
      status: 'Upcoming',
      description: 'An upscale resort offering premium experiences and world-class facilities.Located in George Town,Prayagraj it stands as the nearest three-star hotel to the Sangam, making it an ideal destination for both spiritual travellers and guests seeking comfort, elegance, and convenience.',
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section
        ...
        data-testid="hotels-hero-section"
      >
        <div
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <h1
            ...
            data-testid="hotels-page-heading"
          >
            <span className="text-[#d4af37]">Jagmal</span> Hotels
          </h1>
          <p
      ...
      {/* Portfolio Section */}
      <section className="py-20 md:py-32 bg-slate-950" data-testid="hotels-portfolio-section">
